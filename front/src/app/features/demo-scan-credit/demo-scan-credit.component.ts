...
export class DemoScanCreditComponent {
  ...
  scenarios = [
    { qrCode: 'DEMO-CREDIT-OK', amount: 5, label: 'Paiement 5€', description: 'Solde suffisant — paiement accepté', icon: '💳' },
    { qrCode: 'DEMO-CREDIT-OK', amount: 10, label: 'Paiement 10€', description: 'Solde suffisant — paiement accepté', icon: '💳' },
    { qrCode: 'DEMO-CREDIT-LOW', amount: 100, label: 'Solde insuffisant', description: 'Le solde est trop bas pour ce montant', icon: '⚠️' },
    { qrCode: 'DEMO-CREDIT-INVALID', amount: 5, label: 'QR invalide', description: 'QR code non reconnu dans le système', icon: '🚫' },
  ];
